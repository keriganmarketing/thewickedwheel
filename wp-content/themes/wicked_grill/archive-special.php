	...
	<div id="primary" class="content-area twelve columns">
		...
		<?php if ( have_posts() ) : ?>
			...
			<header class="page-header">
				<?php
					print '<h1 class="page-title">All specials</h1>';
				?>
			</header><!-- .page-header -->
			<div id="tabs">
            	<div class="row">
                    ...
                    <li>
                        <a href="#tabs-<?php the_ID(); ?>">			
                            <div class="row">
                                <div class="special">
                                    <div class="hide-lg special-image twelve columns">
                                    <img src="<?php the_field('special_image'); ?>" />
                                    </div>
                                    <div class="special-bio twelve columns">
                                    <h2><?php echo get_the_title(); ?></h2>
                                    <div class="date">
                                         <span><?php the_field('special_start_date'); ?></span>
                                    </div>                                  
                                  </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="special">
                        	 <div class="date six columns">
                                 ...
                                 <div class="date"><?php the_field('special_start_date'); ?></div>
                                 <div class="tickets">
                            ...
                            <div class="special-image six columns">
                                <img src="<?php the_field('special_image'); ?>" />
                            </div>
                            
                            <div class="special-bio twelve columns">
                           		<?php the_field('special_biography'); ?>
                         	</div>
                            
                            <div class="special-related-shows">
